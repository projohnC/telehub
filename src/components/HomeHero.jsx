      ...
      {!isMovieDataLoading ? (
        <>
          <div className="relative">
            ...
            >
              {movieData.map((movie, index) => {
                const prefix = movie.is_anime
                  ? movie.media_type === "movie" ? "mov" : "ani"
                  : movie.media_type === "movie" ? "mov" : "ser";
            ...
            <div className="absolute right-4 bottom-4 flex gap-2 z-10 md:right-8">
              <button className="heroSlidePrev text-2xl md:text-3xl text-secondaryTextColor/60 hover:text-primaryTextColor transition-colors duration-300">
                <BsArrowLeftCircle />
              </button>
              <button className="heroSlideNext text-2xl md:text-3xl text-secondaryTextColor/60 hover:text-primaryTextColor transition-colors duration-300">
                <BsArrowRightCircle />
              </button>
            </div>
          </div>
