          ...
          <div className="p-0 w-full md:w-1/2 lg:p-6">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#50B498]/10 text-[#50B498] border border-[#50B498]/20 rounded-xl hover:bg-[#50B498]/20 transition-all font-semibold"
              >
                <svg
                  width="24"
                  height="24"
