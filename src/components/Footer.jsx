...
export default function Footer() {
  ...
  return (
    <footer className={`w-full pt-10 pb-8 border-t mt-10 ${isVerificationPage ? "bg-transparent mt-0 py-4 border-slate-200" : "bg-[#08090b] border-white/5"}`}>
      <div className="w-11/12 max-w-7xl mx-auto flex flex-col items-start gap-8">
          ...
          <>
            ...
            <div className="flex flex-col items-start gap-4 w-full">
              ...
              <div className="space-y-4 max-w-5xl">
                ...
                {/* Tags Section */}
                <div className="text-[11px] text-secondaryTextColor/30 leading-relaxed font-normal pt-2 border-t border-white/5 w-full select-none">
                  <span className="font-semibold text-secondaryTextColor/40">Tags: </span>
                  hubstream, hubstream art, hubstream.site, hubstream site, hdmovies.in, hubstream in, hubstream south hindi dubbed, hubstream pro, hubstream apk, all hubstream, South movies, Hubstream.art, hubstream apk, hubstream app, hubstream movies, hubstream streaming, hubstream watch online, hubstream hd, hubstream premium, hubstream online streaming, hubstream fast streaming, movie streaming platform, best movie website, 720p movies, 1080p movies, full hd movies, free movie streaming, online movie streaming
                </div>
              </div>
            </div>
        ...
        <div className={`w-full pt-6 border-t border-white/5 ${isVerificationPage ? "mt-0 pt-0 border-none" : "mt-2"}`}>
          <div className={`flex items-center justify-center gap-2 font-bold text-[10px] md:text-xs tracking-[0.2em] uppercase ${isVerificationPage ? "text-slate-500" : "text-secondaryTextColor/40"}`}>
            <div className={`w-6 h-6 rounded-full border flex items-center justify-center text-[8px] ${isVerificationPage ? "border-slate-300 text-slate-500" : "border-secondaryTextColor/20 text-secondaryTextColor/60"}`}>
              ©
            </div>
