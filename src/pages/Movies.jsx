...
export default function Movies() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setMoviesDataForPageCount(response.data.total_count || animeMovies.length);
  ...
  return (
    <div>
      {/* SEO SECTION */}
      <SEO
        title={`${SITENAME} - Watch Anime Movies Online in HD Quality`}
        description={`Explore a vast collection of anime movies in HD quality on ${SITENAME}. Browse the latest anime film releases, classic hits, and popular titles, complete with subtitles and dual audio. Start streaming today!`}
        name={SITENAME}
        type="text/html"
