...
export default function SimilarMovies() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setMovies(animeResults);
        setMoviesDataForPageCount(response.data.total_count || animeResults.length);
  ...
  return (
    <div>
      {/* SEO SECTION */}
      <SEO
        title={`${SITENAME} - Anime Search Results`}
        description={`Search results for anime movies and series on ${SITENAME}. Stream your favorite subbed and dubbed anime in HD quality.`}
        name={SITENAME}
        type="text/html"
